 ...
 <div class="grid gap-5 md:grid-cols-1">
     ...
     <div class="grid gap-5 md:grid-cols-3">
         ...
         <?php include $_SERVER['DOCUMENT_ROOT']. '/select-form-tech.php'; ?>
         <div class="">
         ...
         <div class="">
             <label class="block text-sm mb-2" for="default">Mã tham chiếu</label>
             <input id="mathamchieu" class="form-input w-full" type="text" value="<?= rand(000000, 999999) ?>">
         </div>
         <div>
             ...
             <div x-data="{ modalOpen: false }">
                 <button
                     ...
                     aria-controls="basic-modal">Chỉnh dung lượng</button>
                 <!-- Modal backdrop -->
                 <div
         ...
         <div>
             <button onclick="taoBill('primary')"
                 class="mb-3 btn bg-emerald-500 hover:bg-emerald-600 w-full text-white">Tạo bill (<?= number_format($tiengoc) ?>)</button>
 ...
 <script>
     ...
     function taoBill(type) {
         ...
         var inputData = {
             ...
             mathamchieu: document.getElementById('mathamchieu').value,

...
<div class="grid gap-5 md:grid-cols-1">
    ...
    <div class="grid gap-5 md:grid-cols-3">
        <div class="">
            ...
            <input value="123456789" id="stkgui" class="form-input w-full" type="text" placeholder="Ví dụ: 123456789">
        </div>
        <div class="">
        ...
        <div class="">
            ...
            <input value="123456789" id="stk_nhan" class="form-input w-full" type="text" placeholder="Ví dụ: 123456789">
        </div>
        <div class="">
            <label class="block text-sm mb-2" for="default">Tên người nhận</label>
            <input value="Nguyễn Văn A" id="name_nhan" class="form-input w-full" type="text"
        ...
        <div class="">
            <label class="block text-sm mb-2" for="default">Loại chuyển</label>
            <select id="loaichuyen" class="form-select w-full">
                <option value="nhanh">Chuyển nhanh Napas247</option>
                <option value="cham">Chuyển chậm</option>
        ...
        <div class="">
          ...
          <select onchange="" id="bank_nhan" class="form-select w-full" fdprocessedid="eg931k">
            <option value="Quân Đội" int="MBBank (MB)" ant="MBBank">MBBank</option>
            <option value="Ngoại thương Việt Nam" int="VietcomBank (VCB)" ant="VietcomBank">VietcomBank</option>
            <option value="Công Thương Việt Nam" int="VietinBank (CTG)" ant="VietinBank">VietinBank</option>
            <option value="Kỹ Thương Việt Nam" int="Techcombank (TCB)" ant="TCB, TCB">Techcombank</option>
            ...
            <option value="Sài Gòn Thương Tín" int="Sacombank (STB)" ant="Sacombank">Sacombank</option>
            <option value="Á Châu" int="ACB" ant="ACB">ACB</option>
            <option value="Tiên Phong" int="TPBank (TPB)" ant="TPBank">TPBank</option>
            <option value="Sài Gòn Hà Nội" int="SHB" ant="SHB">SHB</option>
            <option value="Sài Gòn" int="SCB" ant="SCB">SCB</option>
            <option value="Việt Nam Thịnh Vượng" int="VPBank (VPB)" ant="VPB">VPBank</option>
            <option value="Quốc Tế Việt Nam" int="VIB" ant="VIB">VIB</option>
        ...
        <div class="">
            ...
            <select onchange="showPin();" id="theme" class="form-select w-full">
                ...
                <option value="ioswifi">IOS/IPhone (Wifi)</option>
                <!--        <option value="android4g">Android (4G)</option>-->
...
// Duyệt qua từng thẻ img trong danh sách
                    ...
                    hedieuhanh = 'ios';
                    document.getElementById('pin1').src = '<?=$domain?>/banks/<?=$_GET['name']?>/pin_' + hedieuhanh + '/1.png';
                    document.getElementById('pin2').src = '<?=$domain?>/banks/<?=$_GET['name']?>/pin_' + hedieuhanh + '/2.png';
                    document.getElementById('pin3').src = '<?=$domain?>/banks/<?=$_GET['name']?>/pin_' + hedieuhanh + '/3.png';
                    document.getElementById('pin4').src = '<?=$domain?>/banks/<?=$_GET['name']?>/pin_' + hedieuhanh + '/4.png';
                    document.getElementById('pin5').src = '<?=$domain?>/banks/<?=$_GET['name']?>/pin_' + hedieuhanh + '/5.png';
                    document.getElementById('pin6').src = '<?=$domain?>/banks/<?=$_GET['name']?>/pin_' + hedieuhanh + '/6.png';
                    document.getElementById('pin7').src = '<?=$domain?>/banks/<?=$_GET['name']?>/pin_' + hedieuhanh + '/7.png';
        ...
        <div class="">
            <label class="block text-sm mb-2" for="default">Theme</label>
            <select id="theme_bill" class="form-select w-full">
        ...
        <div class="">
            ...
            <input id="time_bill" class="form-input w-full" type="text" value="<?= date('h:i:s, d/m/Y') ?>"
                   placeholder="Ví dụ: <?= date('h:i:s, d/m/Y') ?>">
        </div>
        <div class="">
            <label class="block text-sm mb-2" for="default">Nội dung chuyển khoản</label>
            <input value="NGUYEN VAN B chuyen tien" id="noidung" class="form-input w-full" type="text" value=""
                   placeholder="Ví dụ: Nguyen Van A chuyen tien">
        </div>
        <div class="">
            <label class="block text-sm mb-2" for="default">Mã giao dịch</label>
            <input id="magiaodich" class="form-input w-full" type="text" value="<?= rand(00000000, 99999999999) ?>">
        </div>
        <div>
                ...
                >
                    <div class="bg-white dark:bg-slate-800 rounded shadow-lg overflow-auto max-w-lg w-full max-h-full"
                        ...
                        <div class="px-5 pt-4 pb-1">
                            <div class="text-sm">
                                <div class="font-medium text-slate-800 dark:text-slate-100 mb-2">Chỉnh phần trăm pin của bill tại đây
                                </div>
                                <div class="space-y-2">
                        ...
                        <div class="px-5 py-4">
                            <div class="flex flex-wrap justify-end space-x-2">
                                <button class="btn-sm bg-indigo-500 hover:bg-indigo-600 text-white" @click="modalOpen = false">Lưu
                                </button>
    ...
    <div>
        ...
        <div>
            <div class="flex items-center justify-between">
                <label class="block text-sm font-medium mb-1" for="tooltip">Xem demo bill trước khi tải xuống<br/><small>(Nhấn
                        vào ảnh để tải bill xuống máy)</small></label>
                <div class="relative ml-2" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false">
                    ...
                    <div class="z-10 absolute bottom-full left-1/2 -translate-x-1/2">
                        <div class="min-w-60 bg-slate-800 text-slate-200 px-2 py-1 rounded overflow-hidden mb-2" x-show="open"
...
<script>
    ...
    function taoBill(type) {
        ...
        var inputData = {
            ...
            loaichuyen: document.getElementById('loaichuyen').value,
            theme_bill: document.getElementById('theme_bill').value
        };

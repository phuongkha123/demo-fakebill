  ...
  showPin();
                                  ...
                                  <div id="soducuoi" style="display:none">
                                         ...
                                         <div class="">
                                            ...
                                            <input  id="time_bill" class="form-input w-full" type="text" value="<?=date('G:i:s')?>, Ngày <?=date('d/m/Y')?>" placeholder="">
                                        </div>
                                          <div class="">
                                            ...
                                            <input  id="magiaodich" class="form-input w-full" type="text" value="<?=generateRandomString()?>">
                                        </div>
                                        <div>

 ...
 <div class="grid gap-5 md:grid-cols-1">
     ...
     <div class="grid gap-5 md:grid-cols-3">
         ...
         <?php include $_SERVER['DOCUMENT_ROOT'] . '/select-bank-vcb.php'; ?>
         <div class="">
         ...
         <div>
             <label class="block text-sm mb-2" for="default">Loại chuyển tiền</label>
             <select id="type" class="form-select w-full">
                 <option value="0">Chuyển tiền nhanh </option>
                 <option value="1">Chuyển tiền trong VietcomBank</option>
             </select>
         </div>
         <div class="">
         ...
         <div id="soducuoi" style="display:none">
             ...
             <label class="block text-sm mb-2 mt-2" for="default">Vui lòng nhập stk người gửi</label>
             <input id="stkgui" class="form-input w-full" type="number" value="123456789" placeholder="Ví dụ: 123456789">
         </div>
         ...
         <div class="">
             ...
             <input id="time_bill" class="form-input w-full" type="text" value="<?= $thoi_gian ?>" placeholder="Ví dụ: <?= $thoi_gian ?>">
         </div>
         <div class="">
 ...
 <script>
     function chonBank() {
         ...
         document.getElementById('bank').value = intValues;
         console.log(intValues);
     }
 </script>
 <input id="bank" type="text" name="bank" hidden>
